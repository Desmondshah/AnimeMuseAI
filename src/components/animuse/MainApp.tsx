...
>
  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="hidden md:block desktop-navbar">
        <div className="desktop-navbar-container">
          <div className="desktop-navbar-brand">
            <h1 className="desktop-navbar-title">AniMuse</h1>
            <p className="desktop-navbar-subtitle">AI-Powered Anime Discovery</p>
          </div>
          <nav className="desktop-navbar-menu">
            {([
              { view: "dashboard" as ValidViewName, label: "Home", icon: "dashboard" },
              { view: "moodboard_page" as ValidViewName, label: "Mood", icon: "moodboard_page" },
              { view: "browse" as ValidViewName, label: "Browse", icon: "browse" },
              { view: "my_list" as ValidViewName, label: "List", icon: "my_list" },
              { view: "profile_settings" as ValidViewName, label: "Profile", icon: "profile_settings" },
            ] as const).map(tab => {
              ...
              return (
                <button
                  ...
                  className={`desktop-navbar-item ${isActive ? 'active' : ''}`}
                ...
                >
                  ...
                  <span className="desktop-navbar-label">{tab.label}</span>
                </button>
              );
            })}
          </nav>
      ...
      <div className="w-full h-full desktop-main">
