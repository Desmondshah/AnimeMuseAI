...
// One Piece test episode data with streaming URLs
const onePieceEpisodes = [
  {
    title: "I'm Luffy! The Man Who's Gonna Be King of the Pirates!",
    thumbnail: "https://i.ytimg.com/vi/Eo9bPd6xLi4/maxresdefault.jpg",
    url: "https://www.crunchyroll.com/watch/GRMG8ZQZR/im-luffy-the-man-whos-gonna-be-king-of-the-pirates",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GR9P3K91Y/enter-the-great-swordsman-pirate-hunter-roronoa-zoro",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GYWE7W5EY/morgan-versus-luffy-whos-the-mysterious-pretty-girl",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GR2P9ZQ8R/luffys-past-enter-red-haired-shanks",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GYGG7J15Y/a-terrifying-mysterious-power-captain-buggy-the-clown-pirate",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/G675917QR/desperate-situation-beast-tamer-mohji-vs-luffy",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GY8V29X9Y/epic-showdown-swordsman-zoro-vs-acrobat-cabaji",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GRDQKPG5R/whos-the-winner-devil-fruit-power-showdown",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/GRE5K5X3R/the-honorable-liar-captain-usopp",
    site: "Crunchyroll",
  ...
  },
  {
    ...
    url: "https://www.crunchyroll.com/watch/G69V0P9PR/the-weirdest-guy-ever-jango-the-hypnotist",
    site: "Crunchyroll",
...
export const addAlternativeStreamingSources = mutation({
  ...
  handler: async (ctx, { animeId }) => {
    try {
      // Add some alternative/demo streaming sources
      const alternativeEpisodes = [
        {
          title: "One Piece Episode 1 - Demo Stream",
          thumbnail: "https://via.placeholder.com/640x360/FF6B6B/FFFFFF?text=EP+1",
          url: "https://www.youtube.com/embed/Eo9bPd6xLi4", // YouTube embed for demo
          site: "YouTube (Demo)",
          previewUrl: "https://www.youtube.com/embed/Eo9bPd6xLi4",
          duration: "24:08",
          airDate: "1999-10-20",
        ...
        {
          title: "One Piece Episode 2 - Demo Stream",
          thumbnail: "https://via.placeholder.com/640x360/4ECDC4/FFFFFF?text=EP+2",
          url: "https://www.youtube.com/embed/2ZqnC-eVwrE",
          site: "YouTube (Demo)",
          previewUrl: "https://www.youtube.com/embed/2ZqnC-eVwrE",
          duration: "24:08",
          airDate: "1999-11-17",
        ...
        {
          title: "One Piece Episode 3 - Demo Stream",
          thumbnail: "https://via.placeholder.com/640x360/45B7D1/FFFFFF?text=EP+3",
          url: "https://www.youtube.com/embed/xvuYduSVGVU",
          site: "YouTube (Demo)",
          previewUrl: "https://www.youtube.com/embed/xvuYduSVGVU",
          duration: "24:08",
          airDate: "1999-11-24",
      ...
      await ctx.db.patch(animeId, {
        streamingEpisodes: alternativeEpisodes
      });

      return {
        success: true,
        message: `Added ${alternativeEpisodes.length} alternative streaming sources for testing`
      };
